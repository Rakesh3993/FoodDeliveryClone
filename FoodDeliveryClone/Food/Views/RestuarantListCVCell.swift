...
class RestuarantListCVCell: UICollectionViewCell {
    ...
    var data: RestuarantListDataModel? {
        didSet {
            guard let data = data else {return}
            restaurantNameLabel.text = data.restuarantName
            restuarantCoverImage.image = UIImage(named: data.restuarantCoverImage)
    ...
    let restuarantCoverImage: UIImageView = {
    ...
    let restaurantNameLabel: UILabel = {
        ...
        label.font = UIFont.customFont(ofType: .bold, withSize: 16)
    ...
    func setUpViews() {
        ...
        restaurantImageCard.addSubview(restuarantCoverImage)
    ...
    func setUpConstraints() {
        restuarantCoverImage.pin(to: restaurantImageCard)
    ...
    func setRestaurantInfoLabel(withRating rating: Float, withTime time: String , withDesc desc: String) -> NSAttributedString {
        ...
        // Star Icon
        let starImg = UIImage(systemName: "star.fill")?.withTintColor(.yellow, renderingMode: .alwaysOriginal)
